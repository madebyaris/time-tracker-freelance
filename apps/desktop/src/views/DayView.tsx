...
import { buildEntryTargetOptions, decodeEntryTarget } from '../lib/time-entry-target';
        ...
        <ul className="divide-y divide-zinc-100 dark:divide-zinc-800">
          {displayEntries.map((entry) => {
            ...
            return (
              <li
                key={entry.id}
                className="group flex items-center gap-3 px-3 py-2 hover:bg-zinc-50 dark:hover:bg-zinc-900/60"
              >
                <span
