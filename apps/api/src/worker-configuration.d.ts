/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c ../../infra/wrangler/wrangler.jsonc src/worker-configuration.d.ts` (hash: c6df2bd1bf1877a5653e81fdc736c84f)
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "staging";
		CORS_ORIGIN: "http://localhost:1420,http://localhost:5173,tauri://localhost";
	...
	interface Env {
		...
		CORS_ORIGIN: "http://localhost:1420,http://localhost:5173,tauri://localhost" | "https://tickr.example.com";
		REGISTRATION_MODE: "first-user" | "open";
		JWT_SECRET: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "CORS_ORIGIN" | "REGISTRATION_MODE" | "JWT_SECRET">> {}
}
